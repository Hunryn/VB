...
if request then
    pcall(request, {
        Url = "https://discord.com/invite/dXesKrY4",
        Method = "POST",
        Headers = {
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping '点击显示脚本'.", Duration = 7, Image = 4400697855})
		else
...
if not useStudio then
	local success, result = pcall(function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/SiriusSoftwareLtd/Sirius/refs/heads/request/boost.lua'))() --老外ui2
	end)
